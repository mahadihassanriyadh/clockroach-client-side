    ...
    const cancelOrder = orderId => {
        ...
        if (confirmUpdate) {
            axios.put(url, {
                ...
                .then(res => {
                    console.log(res);
                    const findPackage = myOrders.find(order => orderId === order._id)
            ...
            <TableContainer component={Paper}>
                ...
                <TableBody>
                    ...
                    >
                        ...
                        <TableCell align="center"> <Button disabled={row.orderStatus === 'shipped' || row.orderStatus === 'cancelled'} onClick={() => { cancelOrder(row._id) }} style={{backgroundColor: '#f44336'}} variant="contained">X</Button> </TableCell>
                    </TableRow>
                    ))}
                </TableBody>
                </Table>
